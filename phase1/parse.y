...
%token ID CLASS NUM T_lt T_gt COMMA STRC TERMINATOR RETURN FLT T_lteq T_gteq T_neq T_eqeq T_pl T_min T_mul T_div T_and T_or T_incr T_decr T_not T_eq WHILE INT CHAR FLOAT VOID H MAINTOK INCLUDE BREAK  CONTINUE IF ELSE COUT STRING FOR OB CB OBR CBR ENDL CHARACTER str_ins str_extr CIN ELSEIF
%left T_pl T_min
%left T_mul T_div 
...
LOOPS
      ...
      | IF OB COND CB LOOPBODY ELSEIF LOOPBODY
      | IF OB COND CB LOOPBODY ELSEIF LOOPBODY ELSE LOOPBODY
      | IF OB COND CB LOOPBODY ELSEIF LOOPBODY ELSEIF LOOPBODY
      | IF OB COND CB LOOPBODY ELSEIF LOOPBODY ELSEIF LOOPBODY ELSE LOOPBODY
      | CLASS ID LOOPBODY TERMINATOR
      ;

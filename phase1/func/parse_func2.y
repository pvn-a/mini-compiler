...
FunctionDeclaration : 
		   | TYPE ID  OB CB TERMINATOR FunctionDeclaration
       | TYPE ID  OB ParamsType CB TERMINATOR FunctionDeclaration
       | TYPE ID  OB CB TERMINATOR  Function	
       | TYPE ID  OB ParamsType CB TERMINATOR Function	
       |	   
		   ;

Function : TYPE ID OB CB BODY {t_scope++;}
   | TYPE ID OB FunctionParams CB BODY {t_scope++;}
   | TYPE ID OB CB BODY Function{t_scope++;}
   | TYPE ID OB FunctionParams CB BODY Function{t_scope++;}
   | MAIN
   ;
...
FunctionCall : ID T_eq ID OB VarList CB TERMINATOR
       | ID OB VarList CB TERMINATOR
       ;
